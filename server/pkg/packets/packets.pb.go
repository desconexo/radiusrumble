...
func (x *RegisterRequestMessage) GetColor() uint32 {
	if x != nil {
		return x.Color
	}
	return 0
...
func (x *DenyResponseMessage) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *PlayerMessage) GetColor() uint32 {
	if x != nil {
		return x.Color
	}
	return 0
...
func (x *Packet) GetFinishBrowsingHiscores() *FinishedBrowsingHiscoresMessage {
	if x != nil {
		if x, ok := x.Msg.(*Packet_FinishBrowsingHiscores); ok {
			return x.FinishBrowsingHiscores
		}
	}
	return nil
}
...
type Packet_FinishBrowsingHiscores struct {
	FinishBrowsingHiscores *FinishedBrowsingHiscoresMessage `protobuf:"bytes,17,opt,name=finish_browsing_hiscores,json=finishBrowsingHiscores,proto3,oneof"`
}
...
func (*Packet_FinishBrowsingHiscores) isPacket_Msg() {}
...
const file_packets_proto_rawDesc = "" +
	...
	"\x05color\x18\x03 \x01(\rR\x05color\"\x13\n" +
	"\x11OkResponseMessage\"'\n" +
	"\x13DenyResponseMessage\x12\x10\n" +
	...
	"\x05color\x18\b \x01(\rR\x05color\"6\n" +
	"\x16PlayerDirectionMessage\x12\x1c\n" +
	"\tdirection\x18\x02 \x01(\x01R\tdirection\"R\n" +
	...
	"\x06reason\x18\x01 \x01(\tR\x06reason\"\xd7\t\n" +
	"\x06Packet\x12\x1b\n" +
	...
	"\vspore_batch\x18\f \x01(\v2\x1a.packets.SporeBatchMessageH\x00R\n" +
	"sporeBatch\x12I\n" +
	...
	"\rhiscore_board\x18\x10 \x01(\v2\x1c.packets.HiscoreBoardMessageH\x00R\fhiscoreBoard\x12d\n" +
	"\x18finish_browsing_hiscores\x18\x11 \x01(\v2(.packets.FinishedBrowsingHiscoresMessageH\x00R\x16finishBrowsingHiscores\x12F\n" +
	...
	"disconnectB\x05\n" +
	"\x03msgB\x1eZ\vpkg/packets\xaa\x02\x0eClient.Packetsb\x06proto3"
...
var file_packets_proto_depIdxs = []int32{
	...
	15, // 17: packets.Packet.finish_browsing_hiscores:type_name -> packets.FinishedBrowsingHiscoresMessage
...
func file_packets_proto_init() {
	...
	file_packets_proto_msgTypes[18].OneofWrappers = []any{
		...
		(*Packet_FinishBrowsingHiscores)(nil),
